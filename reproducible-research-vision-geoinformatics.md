...
## What can we do to fix the compuational research gap?

Well, the short version of it is: we need _carrots_ & _sticks_, _money_ & _time_.
_So no big deal?!_
In our view, there will be no crazy blockchain-based platform for science that completely replaces the funding and review mechanisms we know today, though you should be aware of [topics on scholarly publishing that are widely discussed](https://doi.org/10.3390/publications7020034).
Editors and reviewers at journals serve an important purpose as gatekeepers and curators.
Instead, we should introduce concepts and processes into science that embrace digitisation, especially in a way that allows small and independent journals to embrace them, too.
Such change will need time.
Until there are stronger requirements and an [open infrastructure](https://investinopen.org/), we must note that more and more researchers _do_ increasingly publish all of the building blocks of science, namely data, software, and the used computing environment.
...
Just as with a research manuscript, you take a snapshot of your current work and publish it in reusable form under an open license in a suitable repository, i.e., a repository assigning [a permanent identifier](https://en.wikipedia.org/wiki/Digital_object_identifier).
...
Watch out for courses and workshops related to openness and reproducibility and the next event you participate in.
...
It will be like... the future! We call it an [_Open Research Infrastructure for Geoinformatics_](https://doi.org/10.4230/LIPIcs.COSIT.2019.8), but any community can build upon and extend these ideas as they need.
...
In light of [COVID-19](https://en.wikipedia.org/wiki/Coronavirus_disease_2019) taking a hold of humanity, the limits and challenges around science communication, both within academia and, more importantly, with the public, are broadly revealed.
We should take the opportunity to focus not only on reducing (oftentimes perceived) current barriers, but to foster cultural change and new innovations.
